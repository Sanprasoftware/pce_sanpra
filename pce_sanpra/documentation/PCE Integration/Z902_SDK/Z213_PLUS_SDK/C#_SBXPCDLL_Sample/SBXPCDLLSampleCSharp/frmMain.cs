...
namespace SBXPCDLLSampleCSharp
{
    public partial class frmMain : Form
    {
               ...
               if (lpszDevId.Length >= 6 && lpszDevId.Length <= 16)
                {
                    ...
                    if (Program.gMachineNumber != 0)
                    {
                        ...
                        btnNtpServerSetting.Enabled = true;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            btnNtpServerSetting.Enabled = false;
        ...
        private void btnNtpServerSetting_Click(object sender, EventArgs e)
        {
            frmNtpServerSetting frm = new frmNtpServerSetting();
            frm.Activate();
            frm.Visible = true;
            this.Visible = false;
        }
        ...
        {
            frmNetworkSetting frm = new frmNetworkSetting();
            frm.Activate();
            frm.Visible = true;
            this.Visible = false;
        }
